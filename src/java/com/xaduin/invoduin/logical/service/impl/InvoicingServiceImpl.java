 ...
 * @author manu
 */
@Service("invoicingServiceImpl")
public class InvoicingServiceImpl implements InvoicingService {
    
    // IoC
    @Autowired    
    @Qualifier("invoicesDAOImpl")
    ...
    public void setInvoicesDAO(InvoicesDAO invoiceDAOImpl) {
        this.invoicesDAO = invoiceDAOImpl;
    }
    
    public void setPickLinesDAO(InvoicesDAO invoiceDAOImpl) {
        this.invoicesDAO = invoiceDAOImpl;
    }
